...
const HomePage = () => {
    ...
    return (
        <div className='overflow-x-hidden'>
            ...
            <div className=' h-screen relative'>
                <div style={{ backgroundImage: `url(${herobg.src})` }} className={`w-screen h-screen  bg-cover bg-top relative text-white`}>
                    ...
                    <div className='relative pt-[100px] '>
                        ...
                        <h1 className='text-center mt-6'>Distribute your music to top platforms, grow your <br /> audience, and get the recognition you deserve.</h1>
                        ...
                        <div className='flex justify-center items-center mt-6 relative z-10'>
                            ...
                            <Button variant="blue"><Link href="#">Start Free Now</Link></Button>
                        </div>
                    </div>
                </div>
                <motion.div
                    ...
                    <Image src={hero2} alt="" className='w-screen absolute bottom-[-150px] z-[9]' />
                </motion.div>
            </div>
            <div style={{ backgroundImage: `url(${ourMissionBg.src})` }} className='w-screen relative h-fit bg-cover bg-center mt-[100px] text-white'>
                <div className='w-full flex px-12 items-center justify-center mt-[-80px] absolute z-10'>

                    <div className="relative w-full rounded-4xl overflow-hidden py-8 px-10  bg-[#1D202F]/70   backdrop-blur-md ">
                        <div className={`text-center text-gray-300 text-lg  mb-4 tracking-widest `}>
                ...
                <div className='flex max-lg:flex-col flex-wrap p-12 max-lg:gap-20 pt-50 '>
                    <div className='w-full lg:w-[60%] sm:pr-5'>
                        ...
                        <p className='text-lg text-gray-300 py-4 mb-6 pr-20'>
                            we help artists go live fast — your music hits 100+ stores like Spotify & Apple Music within 48 hours. You keep 100% of your rights, always. No cuts, no control games. And if you need help, real human support is just a call or email away — replies within 24 hours. Simple. Fast. Artist-first.
                        </p>
            ...
            <div className='flex max-lg:flex-col  p-12 py-20 gap-20  justify-between  '>
                ...
                <div className='w-full lg:w-[40%] relative '>
                 ...
                 <div className='w-full lg:w-[60%] flex flex-col justify-center'>
                    ...
                    <p className='text-lg text-gray-300 py-4 mb-6 '>
                        In short, Maheshwari Visuals isn’t just a distributor—it’s a creative ecosystem built to empower, elevate, and evolve with the artist.
                    </p>
            ...
            <div style={{ backgroundImage: `url(${ourServicesBg.src})` }} className='bg-cover bg-center p-12 py-20 flex flex-col justify-center items-center text-white'>
                ...
                <div className='grid grid-cols-3 max-md:grid-cols-1 py-10 justify-items-center w-full '>
                    <motion.div whileHover={{scale: 1.02}} style={{ backgroundImage: `url(${ourservices1.src})` }}  className='h-[500px] w-[400px] rounded-2xl bg-cover bg-center flex flex-col justify-end p-4'>
                        
                         <h1 className={`text-2xl ${anton.className}  uppercase mb-4`}>Music distribution</h1>
                         <p className='text-gray-300 '>Distribute your music to 100+ platforms like Spotify, Apple Music, and more — fast and with full rights.</p>
                    </motion.div>
                    <motion.div whileHover={{scale: 1.02}} style={{ backgroundImage: `url(${ourservices2.src})` }}  className='h-[500px] w-[400px] rounded-2xl bg-cover bg-center flex flex-col justify-end p-4'>
                        
                         <h1 className={`text-2xl ${anton.className}  uppercase mb-4`}>Music Marketing</h1>
                         <p className='text-gray-300 '>Promote your music with smart tools, playlist pitching, social campaigns, and branding support.</p>
                    </motion.div>
                    <motion.div whileHover={{scale: 1.02}} style={{ backgroundImage: `url(${ourservices3.src})` }}  className='h-[500px] w-[400px] rounded-2xl bg-cover bg-center flex flex-col justify-end p-4'>
                        
                         <h1 className={`text-2xl ${anton.className}  uppercase mb-4`}>Content Managment System</h1>
                         <p className='text-gray-300 '>manage your releases, earnings, and data easily with all-in-one CMS Dashboard. Connect Your YT and we help your channel grow</p>
                    </motion.div>
                </div>
            </div>
            <div className='p-12 py-16  flex flex-col justify-center items-center text-white'>
                ...
                <h1 className='text-center w-[80%] text-gray-300'>We have roaster full of Artist and Labels across the Globe. We are here to get you collaborations with artists, fulfilling the needs. Our roaster algorithim will help you to get collaboration according to your taste in Music.</h1>
                <Image src={map} alt='map' className='w-full object-contain mt-10'/>
            </div>

            <div style={{ backgroundImage: `url(${ourServicesBg.src})` }} className='p-12 py-16  text-white bg-cover bg-center'>
