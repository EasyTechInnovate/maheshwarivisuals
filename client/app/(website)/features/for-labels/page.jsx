...
import global from '@/public/images/forlables/global.svg'
import multiartist from '@/public/images/forlables/multiartist.svg'
import royalty from '@/public/images/forlables/royalty.svg'
import advance from '@/public/images/forlables/advance.svg'
import compliance from '@/public/images/forlables/compliance.svg'
import dedicated from '@/public/images/forlables/dedicated.svg'
import royaltyright from '@/public/images/forlables/royaltyright.png'
import dadicatedright from '@/public/images/forlables/dadicatedright.png'
  ...
  return (
    <div className='overflow-x-hidden '>
      <div style={{ backgroundImage: `url(${herobg.src})` }} className='bg-cover bg-center min-h-screen w-full flex flex-col justify-center items-center pt-[150px]'>
        <MainHeadingText text='The new standard for' text2='LABEL services' />
      ...
      <TwoHalfBoxes
        item1={{
          ...
          items: ["Distribute to 100+ DSPs, including Spotify, Apple Music, Amazon, JioSaavn, and YouTube Music", "Direct deals with platforms for high-tier catalog pitching", "Free ISRC/UPC codes and advanced automated metadata correction"]
        }}
        ...
        item2={{
          ...
          items: ['Unified dashboard to manage multiple artists, releases, and brands', 'Sub-label creation and label-tier permissions', 'Bulk metadata editor for fast catalog updates and artwork']
        }}
      />
