    ...
    <div className='overflow-x-hidden '>
      ...
      <TwoHalfBoxes
        item1={{
          ...
          items: ["Distribute to 100+ platforms including Spotify, Apple Music, Amazon, JioSaavn, and YouTube Music", "Fast release turnaround (typically within 48–72 hours)", "Schedule releases in advance with metadata control"]
        }}
        ...
        item2={{
          ...
          items: ['100% royalty retention', 'Transparent quarterly payouts with downloadable TDS certificates', 'Real-time royalty dashboard with stream-by-stream breakdown']
        }}
      />
