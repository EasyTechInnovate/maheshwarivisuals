    ...
    >
      ...
      <div className="flex flex-col md:flex-row md:items-start justify-between gap-4">
        ...
        <div className="flex items-center gap-3 ml-auto">
          ...
          >
            <SelectTrigger
              className={`w-44 rounded-full px-4 py-2 text-sm border-2 border-purple-600 ${
...
>
  ...
  <div
    className={`rounded-lg p-6 flex items-center justify-center border-2 border-dashed h-64 overflow-hidden ${
      isDark
  ...
  >
    {coverArt ? (
      ...
      {/* TRACKS */}
      <AudioUploadSection theme={theme} tracks={trackData} />
      ...
      >
        ...
        <div className="space-y-4">
          <div>
            <label className="text-xs mb-2 block">Release Date</label>
            <Input
              className={`w-full rounded-md ${
                isDark
                  ? "bg-[#0f1724] border border-gray-700 text-gray-200"
          ...
          <div>
            <label className="text-xs mb-2 block">Stores</label>
            <Input
              className={`w-full rounded-md ${
                isDark
                  ? "bg-[#0f1724] border border-gray-700 text-gray-200"
          ...
          <div className="flex justify-center items-center gap-3 pt-4">
            ...
            <Select>
              <SelectTrigger
                className={`w-56 rounded-md px-4 py-2 text-sm border ${
                  isDark
              ...
              >
                ...
                <SelectItem value="silence-end">
                  Audio silence at end
                </SelectItem>
                <SelectItem value="silence-start">
